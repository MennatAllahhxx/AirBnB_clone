...
class TestPlace(unittest.TestCase):
    ...
    def create_instance_with_kwargs(self):
        ...
        self.assertEqual(new_place.name, "Villa")
        self.assertEqual(new_place.city_id, "city-456")
        self.assertEqual(new_place.user_id, "user-345")
        self.assertEqual(new_place.description, "A beautiful villa")
        ...
        self.assertEqual(new_place.price_by_night, 200)
        self.assertEqual(new_place.latitude, 34.0522)
        self.assertEqual(new_place.longitude, -118.2537)
