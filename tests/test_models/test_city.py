...
class TestCity(unittest.TestCase):
    """Test cases against the City class"""
    ...
    def create_instance_without_kwargs(self):
        ...
        self.assertEqual(self.city.name, "farah")
        self.assertEqual(self.city.id, "545-545-545")
    ...
    def create_instance_with_kwargs(self):
        ...
        self.assertEqual(new_city.name, "farah")
        self.assertEqual(new_city.id, "545-545-545")
        self.assertNotEqual(new_city, self.city)
        self.assertDictEqual(new_city.__dict__, self.city.__dict__)
        new_city.state_id = "23-3234"
        new_city.name = "menna"
        new_city.save()
        self.assertEqual(new_city.state_id, "23-3234")
        self.assertEqual(new_city.name, "menna")
        self.assertEqual(new_city.__dict__["name"], "menna")
        self.assertEqual(new_city.__dict__["state_id"], "23-3234")
